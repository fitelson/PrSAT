...
describe('parse', () => {
  ...
  describe('RealExpr', () => {
    ...
    test_parse('9007199254740993', { tag: 'literal', value: 9007199254740992, source: '9007199254740993' })
    test_parse('1000000000000000000000', { tag: 'literal', value: 1e21, source: '1000000000000000000000' })
  ...
  describe('Constraint', () => {
    ...
    test_parse('((((((((Pr(A) = 1))))))))', eq(pr(A), lit(1)))
